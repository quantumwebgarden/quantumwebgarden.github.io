...
var phoneUpdate = phone + '<br><input id="phone' + orderid + '" value="' + phone + '" type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" /><br><input type="button" value="Update Phone" class="button" onclick="updatePhone(\'' + orderid + '\',\'' + stdclass + '\',\'' + roll + '\')">';
