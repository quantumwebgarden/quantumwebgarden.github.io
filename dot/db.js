...
var t = "22.12542";
var g = "88.195623";
var locst = 0; // 0 for current location, 1 for saved location
getuid();
...
function sngl(x) {
    ...
    window.open("single.html?udd=" + u + "=" + el_id + "=" + t + "=" + g + "=" + locst, "_self");
}
