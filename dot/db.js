...
var loadvariable = ["dotpri","dotprirev","name"];
...
Swal.fire({
  ...
  onClose: () => {
    ...
    //console.log(fln + "me");
    if(fln == 1){
      document.getElementById("imgc1").src = "assets/banner/imgc3.jpg";
      document.getElementById("imgc2").src = "assets/banner/imgc2.jpg";
      document.getElementById("imgc3").src = "assets/banner/imgc1.gif";
      document.getElementById("imgc4").src = "assets/banner/imgc4.png";
...
function foodload(){
var rootRef = firebase.database().ref('foods').orderByChild("dotprirev").startAt(loadstart).endAt(loadend);
...
if(id == itemid){
    ...
    document.getElementById("pricesng").innerHTML = "₹ " + price + " <span class=\"offer" + offer + "\">₹ " + priceshp + "</span>";
    ...
    document.getElementById("favd").innerHTML = "<span class=\"ratg" + ratg + "\">" + finalrat + " <i class=\"fa fa-star\" aria-hidden=\"true\"></i><br><i class=\"trat\">(" + ratcnt + ")</i></span>&nbsp;&nbsp;<a onclick=\"fvfd(this)\" class=\"example_fav " + favchk + "\" data-fvl=\"" + favlst + "\" data-itemid=\"" + itemcat + "/" + id + "\"> <i class=\"fa fa-heart\" aria-hidden=\"true\"></i></a>";
