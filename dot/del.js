...
function chkorders(x) {
            ...
            update_dtime(did,ordid,ulat,ulang);
        		$('#orderbody').append('<section ng-repeat="card in cards" class="card theme-green" data-color="#52A43A"><div class="card__map"><iframe src="maponly.html?lat=' + did + '=' + x + '" width="100%" height="100%"></iframe></div><section class="card__part card__part-1"><div class="card__part__inner"><header class="card__header"><div class="card__header__close-btn"></div><span class="card__header__id ng-binding"># ' + ordid + '</span><span class="card__header__price ng-binding">₹' + ordval + '</span></header><div class="card__stats" style="background-image: linear-gradient(141deg, #9fb8ad 0%, #1fc8db 51%, #2cb5e8 75%);"><div class="card__stats__item card__stats__item--req"><p class="card__stats__type">Quantity</p><span class="card__stats__value ng-binding">' + ordqty + '</span></div><div class="card__stats__item card__stats__item--pledge"><p class="card__stats__type">Pay Mode</p><span class="card__stats__value ng-binding">' + ordpay + '</span></div><div class="card__stats__item card__stats__item--weight"><p class="card__stats__type">OTP</p><span class="card__stats__value ng-binding">' + dotp + '</span></div></div></div></section><section class="card__part card__part-2"><div class="card__part__side m--back"><div class="card__part__inner card__face"><div class="card__face__colored-side"></div><h3 class="card__face__price ng-binding">₹' + ordval + '</h3><div class="card__face__divider"></div><div class="card__face__path"></div><div class="card__face__from-to"><p class="ng-binding">' + shopnames + '</p><p class="ng-binding">' + uaddr + '</p></div><div class="card__face__deliv-date ng-binding">' + dtnow + '<p class="ng-binding">' + timenow + '</p></div><div class="card__face__stats card__face__stats--req">Quantity<p class="ng-binding">' + ordqty + '</p></div><div class="card__face__stats card__face__stats--pledge">OTP<p class="ng-binding">' + dotp +'</p></div><div class="card__face__stats card__face__stats--weight">View Details<p class="card__face__stats__weight"><p class="ng-binding"><i class="fa fa-arrow-right" aria-hidden="true"></i></p></div></div></div><div class="card__part__side m--front"><div class="card__sender"><h4 class="card__sender__heading">Delivery Person</h4><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="' + dimg + '"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + dname + '</p><p class="card__sender__rating card__sender__rating-5"> Call: <span class="card__sender__rating__star" style="color: green!important;"><i class="fa fa-phone" aria-hidden="true"></i></span><span class="card__sender__rating__count ng-binding">(<a href="javascript:void(0)" onclick="calldboy(\'call' + dphone + '\')">' + dphone + '</a>)</span></p><p class="card__sender__address ng-binding">4.7 <b style="color: chocolate!important;">★</b><i>(29)</i></p></div><div class="card__receiver"><div class="card__receiver__inner"><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="https://quantumwebgarden.github.io/dot/dotf.png"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + uname + '</p><p class="card__sender__address ng-binding">' + uaddr + '</p></div></div></div><div class="card__path-big"></div></div><div class="card__from-to"><div class="card__from-to__inner"><div class="card__text card__text--left"><p class="card__text__heading">From</p><p class="card__text__middle ng-binding">' + shopnames + '</p><p class="card__text__bottom ng-binding">' + shopaddrs + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">To</p><p class="card__text__middle ng-binding">' + uname + '</p><p class="card__text__bottom ng-binding">' + uaddr + '</p></div></div></div><section class="card__part card__part-3"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><div class="card__timings"><div class="card__timings__inner"><div class="card__text card__text--left"><p class="card__text__heading">Order Time</p><p class="card__text__middle ng-binding">' + timenow +'</p><p class="card__text__bottom ng-binding">' + dtnow + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">Approx Delivery Time</p><p class="card__text__middle ng-binding" id=dtimeupdate' + ordid + '>' + dtimeapprox + '</p></div></div></div><div class="card__timer" id=dtimeupdate2' + ordid + '>' + dtimeapprox + '</div><section class="card__part card__part-4"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><button type="button" class="card__request-btn"><span class="card__request-btn__text-1">View More</span><span class="card__request-btn__text-2">Close</span></button><p class="card__counter ng-binding">Order is on the way</p></div></section></div></section></div></section></section>');
                itemcnt+= 1;
        	}
        	if(dstatus == "23"){
                $('#orderbody').append('<section ng-repeat="card in cards" class="card theme-orange" data-color="#F7AA17"><div class="card__map"><iframe src="delivered.html" width="100%" height="100%"></iframe></div><section class="card__part card__part-1"><div class="card__part__inner"><header class="card__header"><div class="card__header__close-btn"></div><span class="card__header__id ng-binding"># ' + ordid + '</span><span class="card__header__price ng-binding">₹' + ordval + '</span></header><div class="card__stats" style="background-image: linear-gradient(141deg, #9fb8ad 0%, #1fc8db 51%, #2cb5e8 75%);"><div class="card__stats__item card__stats__item--req"><p class="card__stats__type">Quantity</p><span class="card__stats__value ng-binding">' + ordqty + '</span></div><div class="card__stats__item card__stats__item--pledge"><p class="card__stats__type">Pay Mode</p><span class="card__stats__value ng-binding">' + ordpay + '</span></div><div class="card__stats__item card__stats__item--weight"><p class="card__stats__type">OTP</p><span class="card__stats__value ng-binding">' + dotp + '</span></div></div></div></section><section class="card__part card__part-2"><div class="card__part__side m--back"><div class="card__part__inner card__face"><div class="card__face__colored-side"></div><h3 class="card__face__price ng-binding">₹' + ordval + '</h3><div class="card__face__divider"></div><div class="card__face__path"></div><div class="card__face__from-to"><p class="ng-binding">' + shopnames + '</p><p class="ng-binding">' + uaddr + '</p></div><div class="card__face__deliv-date ng-binding">' + dtnow + '<p class="ng-binding">' + timenow + '</p></div><div class="card__face__stats card__face__stats--req">Quantity<p class="ng-binding">' + ordqty + '</p></div><div class="card__face__stats card__face__stats--pledge">OTP<p class="ng-binding">' + dotp +'</p></div><div class="card__face__stats card__face__stats--weight">View Details<p class="card__face__stats__weight"><p class="ng-binding"><i class="fa fa-arrow-right" aria-hidden="true"></i></p></div></div></div><div class="card__part__side m--front"><div class="card__sender"><h4 class="card__sender__heading">Delivery Person</h4><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="' + dimg + '"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + dname + '</p><p class="card__sender__rating card__sender__rating-5"> Call: <span class="card__sender__rating__star" style="color: green!important;"><i class="fa fa-phone" aria-hidden="true"></i></span><span class="card__sender__rating__count ng-binding">(<a href="javascript:void(0)" onclick="calldboy(\'call' + dphone + '\')">' + dphone + '</a>)</span></p><p class="card__sender__address ng-binding">4.7 <b style="color: chocolate!important;">★</b><i>(29)</i></p></div><div class="card__receiver"><div class="card__receiver__inner"><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="https://quantumwebgarden.github.io/dot/dotf.png"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + uname + '</p><p class="card__sender__address ng-binding">' + uaddr + '</p></div></div></div><div class="card__path-big"></div></div><div class="card__from-to"><div class="card__from-to__inner"><div class="card__text card__text--left"><p class="card__text__heading">From</p><p class="card__text__middle ng-binding">' + shopnames + '</p><p class="card__text__bottom ng-binding">' + shopaddrs + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">To</p><p class="card__text__middle ng-binding">' + uname + '</p><p class="card__text__bottom ng-binding">' + uaddr + '</p></div></div></div><section class="card__part card__part-3"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><div class="card__timings"><div class="card__timings__inner"><div class="card__text card__text--left"><p class="card__text__heading">Order Time</p><p class="card__text__middle ng-binding">' + timenow +'</p><p class="card__text__bottom ng-binding">' + dtnow + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">Approx Delivery Time</p><p class="card__text__middle ng-binding">Delivered</p></div></div></div><div class="card__timer">Delivered</div><section class="card__part card__part-4"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><button type="button" class="card__request-btn"><span class="card__request-btn__text-1">View More</span><span class="card__request-btn__text-2">Close</span></button><p class="card__counter ng-binding">Your Order delivered successfully</p></div></section></div></section></div></section></section>');
                itemcnt+= 1;
        	}
        	if(dstatus == "28" || dstatus == "19" || dstatus == "29"){
                $('#orderbody').append('<section ng-repeat="card in cards" class="card theme-red" data-color="#EF5350"><div class="card__map"><iframe src="error.html" width="100%" height="100%"></iframe></div><section class="card__part card__part-1"><div class="card__part__inner"><header class="card__header"><div class="card__header__close-btn"></div><span class="card__header__id ng-binding"># ' + ordid + '</span><span class="card__header__price ng-binding">₹' + ordval + '</span></header><div class="card__stats" style="background-image: linear-gradient(141deg, #9fb8ad 0%, #1fc8db 51%, #2cb5e8 75%);"><div class="card__stats__item card__stats__item--req"><p class="card__stats__type">Quantity</p><span class="card__stats__value ng-binding">' + ordqty + '</span></div><div class="card__stats__item card__stats__item--pledge"><p class="card__stats__type">Pay Mode</p><span class="card__stats__value ng-binding">' + ordpay + '</span></div><div class="card__stats__item card__stats__item--weight"><p class="card__stats__type">OTP</p><span class="card__stats__value ng-binding">' + dotp + '</span></div></div></div></section><section class="card__part card__part-2"><div class="card__part__side m--back"><div class="card__part__inner card__face"><div class="card__face__colored-side"></div><h3 class="card__face__price ng-binding">₹' + ordval + '</h3><div class="card__face__divider"></div><div class="card__face__path"></div><div class="card__face__from-to"><p class="ng-binding">' + shopnames + '</p><p class="ng-binding">' + uaddr + '</p></div><div class="card__face__deliv-date ng-binding">' + dtnow + '<p class="ng-binding">' + timenow + '</p></div><div class="card__face__stats card__face__stats--req">Quantity<p class="ng-binding">' + ordqty + '</p></div><div class="card__face__stats card__face__stats--pledge">OTP<p class="ng-binding">' + dotp +'</p></div><div class="card__face__stats card__face__stats--weight">View Details<p class="card__face__stats__weight"><p class="ng-binding"><i class="fa fa-arrow-right" aria-hidden="true"></i></p></div></div></div><div class="card__part__side m--front"><div class="card__sender"><h4 class="card__sender__heading">Delivery Person</h4><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="' + dimg + '"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + dname + '</p><p class="card__sender__rating card__sender__rating-5"> Call: <span class="card__sender__rating__star" style="color: green!important;"><i class="fa fa-phone" aria-hidden="true"></i></span><span class="card__sender__rating__count ng-binding">(<a href="javascript:void(0)" onclick="calldboy(\'call' + dphone + '\')">' + dphone + '</a>)</span></p><p class="card__sender__address ng-binding">4.7 <b style="color: chocolate!important;">★</b><i>(29)</i></p></div><div class="card__receiver"><div class="card__receiver__inner"><div class="card__sender__img-cont"><div class="card__sender__img-cont__inner"><img class="card__sender__img" src="https://quantumwebgarden.github.io/dot/dotf.png"></div></div><div class="card__sender__name-and-rating"><p class="card__sender__name ng-binding">' + uname + '</p><p class="card__sender__address ng-binding">' + uaddr + '</p></div></div></div><div class="card__path-big"></div></div><div class="card__from-to"><div class="card__from-to__inner"><div class="card__text card__text--left"><p class="card__text__heading">From</p><p class="card__text__middle ng-binding">' + shopnames + '</p><p class="card__text__bottom ng-binding">' + shopaddrs + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">To</p><p class="card__text__middle ng-binding">' + uname + '</p><p class="card__text__bottom ng-binding">' + uaddr + '</p></div></div></div><section class="card__part card__part-3"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><div class="card__timings"><div class="card__timings__inner"><div class="card__text card__text--left"><p class="card__text__heading">Order Time</p><p class="card__text__middle ng-binding">' + timenow +'</p><p class="card__text__bottom ng-binding">' + dtnow + '</p></div><div class="card__text card__text--right"><p class="card__text__heading">Approx Delivery Time</p><p class="card__text__middle ng-binding">No details available</p></div></div></div><div class="card__timer">No more details</div><section class="card__part card__part-4"><div class="card__part__side m--back"></div><div class="card__part__side m--front"><button type="button" class="card__request-btn"><span class="card__request-btn__text-1">View More</span><span class="card__request-btn__text-2">Close</span></button><p class="card__counter ng-binding">Something went wrong for this order</p></div></section></div></section></div></section></section>');
                itemcnt+= 1;
        	}
