  ...
  if(cart.length > 0) {
    var cartAddBtns = document.getElementsByClassName('js-cd-add-to-cart'),
        ...
        function addProduct(ctid,price,itemid,itemname,itempic,qnty) {
            ...
            //qnty = productId + 1;
            pr_qt = price/qnty;
            var productAdded = '<li class="cd-cart__product" data-ctid="' + ctid + '"><div class="cd-cart__image"><a href="#0"><img src="' + itempic + '" alt="' + itemname + '"></a></div><div class="cd-cart__details"><h3 class="truncate"><a href="#0">' + itemname + '</a></h3><span class="cd-cart__price">' + price + '</span><div class="cd-cart__actions"><a href="#0" id="del'+ itemid +'" class="cd-cart__delete-item" data-id="' + itemid + '" data-price="' + pr_qt + '" data-qty="' + qnty + '">Delete</a><div class="cd-cart__quantity"><label for="cd-product-'+ itemid +'">Qty</label><span class="cd-cart__select"> <img class="mn' + qnty + '" src="minus.png" width="20px" height="20px" data-qty="' + qnty + '" data-itemid="' + itemid + '" id="minus' + itemid + '" onclick="rmv(this)"> <b class="reset" id="cd-product-'+ itemid +'" name="quantity">' + qnty + '</b> <img src="plus.png" width="20px" height="20px" data-qty="' + qnty + '" data-itemid="' + itemid + '" onclick="adc(this)"><svg class="icon" viewBox="0 0 12 12"><polyline fill="none" stroke="currentColor" points="2,4 6,8 10,4 "/></svg></span></div></div></div></li>';
