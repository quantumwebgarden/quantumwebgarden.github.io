...
prizePool:document.getElementById("prizeType").value,
visible:1,
joined:0
});
...
var timestamp = date.getTime();
timestamp = 2554396200000 - timestamp;
firebase.database().ref('freefire/prizePool/' + timestamp).set({
poolId:timestamp,
firstAmount:document.getElementById("1stAmount").value,
secondAmount:document.getElementById("2ndAmount").value,
thirdAmount:document.getElementById("3rdAmount").value,
FToSAmount:document.getElementById("4thTo7thAmount").value,
perKillAmount:document.getElementById("perKillAmount").value,
